...
use crate::driving::{graphql, rest_handler};
use crate::driving::graphql::schema::create_schema;
    ...
    cfg
        .service(
            web::scope("/recipes")
                ...
                // graphql
                .route("/graphql", web::get().to(graphql::sandwiches::sandwiches_graph::<SandwichSqlRepository>))
        );
}